...
CREATE TABLE Seguir
(
    idSegue INT REFERENCES Utilizador(id) ON DELETE CASCADE ON UPDATE CASCADE,
    idSeguido INT REFERENCES Utilizador(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    ...
    descricao TEXT,
    classificacao INT,
    idFaixaEtaria INT REFERENCES FaixaEtaria(id) ON DELETE SET NULL,
...
(
    ...
    CHECK (dataLancamento <= CURRENT_DATE),
    CHECK (DURACAO > 0)
);
...
(
    ...
    localFilmagem TEXT,
    linguagem TEXT,
    idTemporada INT REFERENCES Temporada(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    ...
    idUtilizador INT REFERENCES Utilizador(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    idCategoria INT REFERENCES Categoria(id) ON DELETE CASCADE,
    idItem INT REFERENCES Item(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    idPlataforma INT REFERENCES Plataforma(id) ON DELETE CASCADE ON UPDATE CASCADE,
    idItem INT REFERENCES Item(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    idLista INT REFERENCES Lista(id) ON DELETE CASCADE ON UPDATE CASCADE,
    idUtilizador INT REFERENCES Utilizador(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
    idParticipante INT REFERENCES Participante(id) ON DELETE CASCADE ON UPDATE CASCADE,
    idItem INT REFERENCES Item(id) ON DELETE CASCADE ON UPDATE CASCADE,
